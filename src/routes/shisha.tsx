  ...
  return (
    <div className="pt-24">
      <section className="relative flex h-[60vh] items-center justify-center overflow-hidden text-center">
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at center, rgba(201,168,76,0.2), transparent 60%), linear-gradient(180deg, #0a0a0a, #1a1200)" }} />
        ...
        <div className="mx-auto grid max-w-5xl gap-5 px-2 sm:grid-cols-2 lg:grid-cols-3">
          {FLAVOURS.map((f, i) => (
            <motion.div
              ...
              className="group rounded-2xl border border-[var(--gold)]/30 bg-black/50 p-7 transition-all hover:-translate-y-1 hover:gold-glow"
            >
